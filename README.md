...
Because it is an architectural project, UI has been kept simple. Sample data has been provided from [University API](https://api.openuniversitymap.org/data/2.5/) 
